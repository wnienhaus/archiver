...
- [ ] add progress indicator (simply percentage) to the verify command (since we know how many files there are)
...
- [ ] for symlinks, consider their size to always be 0, since it does not matter and the actual size is filesystem dependent.
